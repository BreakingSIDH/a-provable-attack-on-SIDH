...
Which was orignally used for the SageMath implementation of the Castryck-Decru
attack: https://eprint.iacr.org/2022/975.pdf, as well as the variant of the
attack described by Oudompheng
https://www.normalesup.org/~oudomphe/textes/202208-castryck-decru-shortcut.pdf

# NOTE: many internal checks in the following functions are of the form of 
        asserts.
...
def FromProdToJac(C, E, P_c, Q_c, P, Q, a):
    ...
    https://eprint.iacr.org/2022/1283
    """
    Fp2 = C.base()
    Rx.<x> = Fp2[]
